...
int main(int argc, char *argv[]) {
    ...
    Client client;
    client.Initialize(PUB_1, SUB_1, context);
    ...
    while (GameManager::getInstance()->gameRunning) {
        ...
        key_movement.calculate(*char_1, direction);

        client.messageQueue.enqueue({MessageType::CHAR_1, char_1->rect.x, char_1->rect.y});
